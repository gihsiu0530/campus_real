...
{
    ros::init(argc, argv,"amcl_global_park");
    ROS_INFO("~~~~~global path start~~~~");
    ros::NodeHandle nh;
    //Publisher
    ros::Publisher pub = nh.advertise<std_msgs::Float64MultiArray>("park_topic",100);    //to local_path  //to change
    ros::Publisher path_length_pub = nh.advertise<std_msgs::Float32>("global_park_length", 1);

    //rviz
    ros::Publisher cached_waypoint_show_pub_ = nh.advertise<visualization_msgs::MarkerArray>("global_park",1000);

    std::string line;

    //開啟csv 檔案路徑
    //std::ifstream inFile("/home/king/mpc/turn0106.csv",std::ios::in);
    //std::ifstream inFile("/home/king/golf_ws/mpc/0103_straight.csv",std::ios::in); 
    ...
    //std::ifstream inFile("/home/king/golf_ws/mpc/straight.csv",std::ios::in); 
    ...
    // std::ifstream inFile("/home/cyc/park_straight.csv",std::ios::in); 
    std::ifstream inFile("/home/cyc/back_points.csv",std::ios::in); 
    ...
    global_path_plot_marker.color.g = 1;
    global_path_plot_marker.color.b = 1;
