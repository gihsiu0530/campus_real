...
#include <std_msgs/Int32.h>
    ...
    {   //ros::NodeHandle nh_;
        ...
        private:
            ...
            double min_v_forward_ = 0.40;   // 前進最小速度
            double max_v_forward_ = 0.40;   // 前進最大速度
            ...
            double max_delta_inc_= 0.018;          //角度差值
            //double max_delta_inc_= 0.0134;          //角度差值 //0.0134
            //double max_delta_inc_= 0.0067;          //角度差值
            //double max_delta_inc_= 0.0084;
            //double max_delta_inc_= 0.0067;
            //double max_delta_inc_= 0.01004;
            //double max_delta_inc_= 0.016;  //park 4 sim
            //double max_delta_inc_= 0.0168;  //park other sim
